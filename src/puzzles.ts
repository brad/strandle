...
export const PUZZLES: Puzzle[] = [
  ...
  {
    spangram: "BREAKFAST",
    words: ["BREAKFAST", "WAFFLE", "PANCAKE", "BACON", "JUICE", "EGGS"],
    grid: [
      "WAFEGJ",
      "ELFSGU",
      "BACOCI",
    ...
    paths: {
      BREAKFAST: [[3, 0], [4, 0], [5, 0], [5, 1], [4, 1], [3, 1], [3, 2], [4, 2], [5, 2]],
      WAFFLE: [[0, 0], [0, 1], [0, 2], [1, 2], [1, 1], [1, 0]],
      PANCAKE: [[5, 3], [5, 4], [5, 5], [4, 5], [3, 5], [4, 4], [4, 3]],
      BACON: [[2, 0], [2, 1], [2, 2], [2, 3], [3, 3]],
      JUICE: [[0, 5], [1, 5], [2, 5], [2, 4], [3, 4]],
      EGGS: [[0, 3], [0, 4], [1, 4], [1, 3]]
    }
  }
];
